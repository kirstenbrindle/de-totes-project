...
def patch_fixture():
    with patch("src.transform_handler2.transform_handler2."
            ...
            as mock_cpc:
        yield (mock_gfaibn, mock_gbn2, mock_ibe2,
               mock_gmrf2, mock_rctd, mock_cpc)
...
@patch('src.transform_handler2.transform_handler2.'
       'get_bucket_name_2')
@mock_aws
def test_lambda_handler2_invokes_gfaibn(mock_gbn2, mock_gfaibn, mock_s3):
...
@patch("src.transform_handler2.transform_handler2."
       "get_bucket_name_2")
@mock_aws
def test_lambda_handler2_invokes_gbn2(mock_gbn2, mock_gfaibn, mock_s3):
